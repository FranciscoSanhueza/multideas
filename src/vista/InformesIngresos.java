 ...
 * @author pancho-PC
 */
public class InformesIngresos extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form InformesIngresos
     */
    public InformesIngresos() {
        initComponents();
        ...
        V.IngresosPorFecha(Ventas, fecha11, fecha11);
        cargarTabla();
        cargarFechasDEfecto();
    }
    ...
    public void cargarTabla() {
        if (Ventas.isEmpty()) {
            ...
            for (movimiento mm : Ventas) {
                ...
                if (V.BuscarProductosIngreso(mm.getCodigo()) != null) {
                    Productos = V.BuscarProductosIngreso(mm.getCodigo());
    ...
    private void initComponents() {
        ...
        dialogoProductosIngreso = new javax.swing.JDialog();
        ...
        javax.swing.GroupLayout dialogoProductosIngresoLayout = new javax.swing.GroupLayout(dialogoProductosIngreso.getContentPane());
        dialogoProductosIngreso.getContentPane().setLayout(dialogoProductosIngresoLayout);
        dialogoProductosIngresoLayout.setHorizontalGroup(
            dialogoProductosIngresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(dialogoProductosIngresoLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 457, Short.MAX_VALUE)
                .addContainerGap())
        );
        dialogoProductosIngresoLayout.setVerticalGroup(
            dialogoProductosIngresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(dialogoProductosIngresoLayout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED), "Filtro de Ingresos", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (diferencia()) {
            ...
            V.IngresosPorFecha(Ventas, fecha11, fecha22);
            limpiarTabla();
            this.cargarTabla();
            }else{
    ...
    private void tablaVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaVentasMouseClicked
        try {
            ...
            String detalle = "";
            String fecha;
            if (V.BuscarProductosIngreso(codigoVenta) != null) {
                Productos = V.BuscarProductosIngreso(codigoVenta);
                if (Productos == null) {
                    JOptionPane.showMessageDialog(null, "No existen productos en este ingreso");
                } else {
                    ...
                    this.dialogoProductosIngreso.setVisible(true);
                    this.dialogoProductosIngreso.setSize(600, 300);
                    this.dialogoProductosIngreso.setLocationRelativeTo(null);
                }
            } else {
                JOptionPane.showMessageDialog(null, "Ingreso Sin Productos");
            }
    ...
    private javax.swing.JDialog dialogoProductosIngreso;
